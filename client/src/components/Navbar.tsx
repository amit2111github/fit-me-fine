        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-6">
            ...
            >
              ...
              <Bell className="h-6 w-6 text-primary-foreground/90 hover:text-primary-foreground 
              ...
              <UserButton
                appearance={{
                  ...
                  elements: {
                    ...
                    userButtonOuterIdentifier: "text-primary-foreground/90 hover:text-primary-foreground",
                    userButtonBox: "scale-90 sm:scale-100 hover:scale-105",
                    userButtonAvatarBox: "h-8 w-8 border-2 border-primary-foreground/20 hover:border-primary-foreground/40",
